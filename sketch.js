...
function draw(){
  ...
  // wall3.visible=false;
   ...
   wall4.visibility();
    wall1.touch();
    wall2.touch();
   if(man1.isTouching(lifeboat) && gamestate==="play" ){
    rescued++
    man1.destroy();
    victorysound.play();
    //if(frameCount&60===0){
   ...
   if(man2.isTouching(lifeboat) && gamestate==="play" ){
    man2.destroy();
    rescued++
    victorysound.play();
   }  
    ...
    man2.setCollider("rectangle",0,0,700,700)
    man1.setCollider("rectangle",0,0,700,700)  
